...
public class TimeScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MyGameManager.Instance.setClock(this);
    ...
    private void shakeClock()
    {
        ...
        {
            comment = MyGameManager.Instance.getAlexaText("timeLeft90");
        ...
        {
            comment = MyGameManager.Instance.getAlexaText("timeLeft60");
        ...
        {
            comment = MyGameManager.Instance.getAlexaText("timeLeft30");
        ...
        {
            comment = MyGameManager.Instance.getAlexaText("timeLeft15");
    ...
    private void startShake(float shakeForce, AudioClip clip, float shakeDuration, string comment)
    {
        ...
        MyGameManager.Instance.ActivateAlexa(clip, comment);
